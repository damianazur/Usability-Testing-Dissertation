...
class TaskWindow(QWidget):
    def __init__(self, taskData, previousTaskPos):
    ...
    def renderTask(self, taskData):
        jsonSteps = json.loads(taskData["stepsJSON"])

        # Create instruction text body
        stepIndex = 1
        stepString = "Task: " + taskData["taskName"] + "\n\n"
